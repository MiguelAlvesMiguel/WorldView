...
export function FluidDynamics({
  ...
  return (
    <div className={`fixed inset-0 w-full h-full overflow-hidden pointer-events-auto ${className}`}>
      <canvas
        ref={canvasRef}
